...
__VENDOR = '2232549876@qq.com'
__VERSION= '2019-03-04'

def initializePlugin(obj):
    plugin = maya.MFnPlugin(obj, __VENDOR, __VERSION)
    try:
        plugin.registerCommand(HelloMaya.command, HelloMaya.creator)
    except:
        sys.stderr.write('register plugin command failed')
        raise
...
def uninitializePlugin(obj):
    ...
    try:
        ...
        sys.stderr.write('deregister plugin command failed')
        raise
